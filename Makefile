...
test:
	...
	$(PYTHON) tests/test_polyhaven_pack.py
	$(PYTHON) tests/test_context_benchmark.py
	$(PYTHON) tests/test_agent_experience.py
...
# Build + install the addon and launch a background Blender on an isolated port.
#   PORT=9988 make demo-blender
demo-blender:
	$(SHELL) _misc/launch_demo_blender.sh
